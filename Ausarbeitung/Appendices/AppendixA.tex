...
\chapter{A Little Scala DSL} % Main appendix title

\label{AppendixA} % For referencing this appendix elsewhere, use \ref{AppendixA}

\lhead{Appendix A. \emph{A Little DSL in Scala}} % This is for the header on each page - perhaps a shortened title
